...
@section('title', 'Myplanbase Client Portal - Login')
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <div class="d-flex align-items-center">
                    <div class="w-100">
                        <img src="{{ asset('img/client/cropped-zipkit-logo.png') }}" alt="Myplanbase Logo"
                            class="login-logo">
                    </div>
                </div>
                    ...
                    <div class="wrap-input100 validate-input m-b-20">
                        ...
                        <div class="container-login-form-btn mt-5">
                            ...
                            @else
                                <button disabled="disabled" type="button" role="button"
                                    class="login-form-btn login100-form-btn">{{ __('SEND MY CODE') }}</button>
                            @endif
                        </div>
                        ...
                        @else
                            @if (!$is_active)
                                <div class="col-md-12 text-center">
                                    <p class="text-danger mt-2">
                                        {{ __('This portal is inactive. Please email admin@myplanbase.com for help.') }}
                                    </p>
                                </div>
                            @endif
                        @endif
                        <div class="col-md-12 text-center mt-3">
                            <a target="_blank"
                                href=""
                                class="font-weight-bold"><i class="fa fa-question-circle"
