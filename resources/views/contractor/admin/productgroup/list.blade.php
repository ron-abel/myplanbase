    ...
    <div class=" card card-custom mt-6">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Button-->
                <a href="{{ route('contractor.admin.productgroups.create', ['subdomain' => $subdomain]) }}" class="btn btn-primary font-weight-bolder">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-end">
                            <a href="{{ route('contractor.admin.productgroups.edit', ['productgroup' => $productgroup->id, 'subdomain' => $subdomain]) }}" class="btn btn-sm btn-clean btn-icon"><i class="icon-xl la la-pen"></i></a>
                            <a href="{{ route('contractor.admin.productgroups.destroy', ['productgroup' => $productgroup->id, 'subdomain' => $subdomain]) }}" class="btn btn-sm btn-clean btn-icon delete"><i class="icon-xl la la-trash-o"></i></a>
                        </td>
                    </tr>
                    @empty
