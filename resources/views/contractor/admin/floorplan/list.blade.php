    ...
    <div class=" card card-custom mt-6">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('contractor.admin.floorplans.create', ['subdomain' => $subdomain]) }}" class="btn btn-primary font-weight-bolder">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <video style="width:100% !important; height: auto !important; object-fit: cover;"controls>
                                    <source src="{{isset($floorplan->videos[0]) ? $floorplan->videos[0]['vid_url'] : '' }}">
                                </video>
                                @endif
                            </div>
                        </td>
                        <td class="d-flex justify-content-end">
                            <a href="{{ route('contractor.admin.floorplans.edit', ['floorplan' => $floorplan->id, 'subdomain' => $subdomain]) }}" class="btn btn-sm btn-clean btn-icon"><i class="icon-xl la la-pen"></i></a>
                            <a href="{{ route('contractor.admin.floorplans.destroy', ['floorplan' => $floorplan->id, 'subdomain' => $subdomain]) }}" class="btn btn-sm btn-clean btn-icon delete"><i class="icon-xl la la-trash-o"></i></a>
                        </td>
                    </tr>
                    @empty
