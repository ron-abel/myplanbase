    ...
    <div class="row mt-6">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <form action="{{ route('contractor.admin.floorplans.update', ['floorplan' => $floorplan->id, 'subdomain' => $subdomain]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="card-body">
                        @include('contractor.admin.floorplan.form', ['floorplan' => $floorplan, 'image_cnt' => count($floorplan->images), 'video_cnt' => count($floorplan->videos)])
