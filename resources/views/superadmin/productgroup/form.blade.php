    ...
    <div class="form-group col-lg-6 col-lg-5">
        <input id="keyvideoname" name="keyvideoname" class="form-control form-control-solid @error('keyvideoname') is-invalid @enderror" placeholder="Enter key video name" value="{{ old('keyvideoname', $productgroup['keyvideoname']) }}">
        @error('keyvideoname')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group col-lg-4 col-lg-4">
        <div class="custom-file">
            <input type="hidden" name="keyvideolink" value="{{ old('keyvideolink', $productgroup['keyvideolink']) }}">
            <input type="file" class="custom-file-input @error('keyvideolink') is-invalid @enderror" id="customFile">
            <label class="custom-file-label" for="customFile">{{ old('keyvideolink', $productgroup['keyvideolink']) == "" ? "DRAG PICTURE HERE" : "File attached" }}</label>
            @error('keyvideolink')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
...
<div class="row align-items-start">
    ...
    <div class="form-group col-lg-6 col-lg-5">
        <input id="video2name" name="video2name" class="form-control form-control-solid @error('video2name') is-invalid @enderror" placeholder="Enter video 2 name" value="{{ old('video2name', $productgroup['video2name']) }}">
        @error('video2name')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group col-lg-4 col-lg-4">
        <div class="custom-file">
            <input type="hidden" name="video2link" value="{{ old('video2link', $productgroup['video2link']) }}">
            <input type="file" class="custom-file-input @error('video2link') is-invalid @enderror" id="customFile">
            <label class="custom-file-label" for="customFile">{{ old('video2link', $productgroup['video2link']) == "" ? "DRAG PICTURE HERE" : "File attached" }}</label>
            @error('video2link')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
