    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center">
            ...
            <div class="d-flex flex-column flex-row-fluid text-center">
                <h1 class="display-1 font-weight-boldest" style="margin-top: 3rem; color:#ff822a">UH OH.</h1>
                <h2 class="font-weight-bold custom-text-secondary">A connection with our servers has been interrupted.
                    <br> Please email us at
                    <a href="mailto:admin@myplanbase.com"
                        class="text-dark text-decoration-underline">admin@myplanbase.com</a>
                </h2>
                <div class="text-center mt-12">
                    <img src="{{ asset('img/404-icon.png') }}" class="img-fluid" alt="myplanbase 404 icon">
                </div>
            </div>
            <!--end::Content-->
        </div>
