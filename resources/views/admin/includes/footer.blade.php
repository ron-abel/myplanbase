<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-fluid d-flex flex-column align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            <span class="text-muted font-weight-bold mr-2">Copyright &copy; <?php echo date("Y"); ?> Myplanbase Contractor Portal by <a href="#">Myplanbase</a>. All Rights Reserved. <a href="#">@version('footer-version')</a> </span>
        </div>
        <!--end::Copyright-->
        <!--begin::Nav-->
