...
$(".add-more").on('click', (function (e) {
    if ($('#projectType').val() > 0 && $("#ProjectsVital").val() != "" && $("#ProjectsVital").val() != null) {
        ...
        var html = '<div class="row project-vital"> <div class="col-md-3 pt-6 vitalSlotOrder"> </div><div class="col-md-5 pt-3">';
...
$('.save-Project-Vitals').click(function () {
    ...
    console.log(projectTypeId, projectType);
    ...
    let vital_value = [];
    $(".project-vital").each(function () {
        vital_value.push({ 'friendly_name': $(this).find('.friendly_name').val(), 'field_name': $(this).find('.field_name').val() });
    });
